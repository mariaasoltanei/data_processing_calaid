...
dfTest = pd.read_csv('/mnt/c/Users/sltnm/Desktop/FACULTATE/LICENTA/data_processing_calaid/phase2/test.csv')
...
parameters = {'C':[0.01, 0.1, 30], 'penalty':['l2','l1'], 'tol':[0.00000001,0.000000001]}
